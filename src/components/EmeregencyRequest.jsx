        ...
        <div className="blood-request-form">
            ...
            {existingRequests.length > 0 && (
                <div className="existing-requests">
                    <h3>Existing Emergency Blood Requests:</h3>
                    <ul className="space-y-4">
                        {existingRequests.map((request, index) => (
                            <li key={index} className="bg-white shadow-lg rounded-lg p-4 border border-gray-300">
                                <div className="flex items-center space-x-4">
                                    <div className="flex flex-col">
                                        <strong className="text-lg font-bold text-blue-500">{request.bloodGroup}</strong>
